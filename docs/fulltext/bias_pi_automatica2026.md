...
本轮通读正式 PDF 全部13页，包括正文证明、p11 Appendix、参考文献和作者信息；p5、6、7、8、10另核PDF图像。不是此前的摘要/预览记录。[所读PDF](../ARTIFACTS.md) SHA-256：`93ca24abebbe6a139457b32fa387f197ba54f76f7a3e17f07dbda72837df1e69`。下述均为正式PDF页码。全文未给代码下载地址，不据此断言作者没有代码。
