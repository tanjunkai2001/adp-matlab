...
| Safe epigraph PINN | Constrained boat navigation | Reduced training: 19/64 collisions and 47/64 budget violations. Author-checkpoint evaluation: 1/64 and 9/64, respectively. | [Record](../evidence/v0.3/safe-pinn/RESULTS.md) |
