...
|---|---|---|---|
| v0.5: public reference | Bilingual README, complete entry navigation, source-only checkout, contribution templates, citation, project page | [Validation and source identity](../VALIDATION.md), MIT license, [first GitHub CI record](validation/github-actions-first-run.json), published repository and project page | [v0.5.0 published](https://github.com/tanjunkai2001/adp-matlab/releases/tag/v0.5.0) on 2026-09-08 |
