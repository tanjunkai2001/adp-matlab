...
|---|---|---|---|
| v0.5: public reference | Bilingual README, complete entry navigation, source-only checkout, contribution templates, citation, project page | Local tests, source identity, working links, chosen license, first GitHub CI run, published repository and page | Code/docs prepared; public release pending |
...
|---|---|---|
| Run the source on Linux with R2025b | Validate the prepared GitHub workflow | All discovered tests complete; numerical/platform differences are investigated and recorded |
