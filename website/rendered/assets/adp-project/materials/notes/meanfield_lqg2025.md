...
**实际调试与初始结论。** MATLAB R2025b 实际执行了数据生成、两个 PI、广义 Riccati 参考、平均场采样和群体成本。第一轮 100 路径的 K/Ks 相对误差为 18.23%/30.01%，8 次独立训练 1 次被拒绝；失败和随机种子均保留，没有替换为更好种子。相同 probe 增至 4000 路径后，主实验误差约 0.53%/0.85%，有限群体成本约 459.52，而模型参考约 459.51。完整复核结果、增益标准误和成本标准误以 [证据目录](https://github.com/tanjunkai2001/adp-matlab/blob/v0.5.0/docs/ARTIFACTS.md) 中的 CSV/MAT/日志为准。
