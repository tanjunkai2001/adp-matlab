...
[Summary](https://github.com/tanjunkai2001/adp-matlab/blob/main/docs/validation/matlab-tests.json) · [Per-test CSV](https://github.com/tanjunkai2001/adp-matlab/blob/main/docs/validation/matlab-tests.csv) · [81 source hashes](https://github.com/tanjunkai2001/adp-matlab/blob/main/docs/validation/matlab-source-hashes.json)
...
|---|---|
| Baseline | Analytic LQR gain/value comparison and Bellman checks. Figures retain the recorded September 7 experiments. A fresh September 8 quickstart independently returns the same gain; see its [metrics](https://github.com/tanjunkai2001/adp-matlab/blob/main/docs/validation/quickstart-baseline.json). |
...
See the [method cards](https://github.com/tanjunkai2001/adp-matlab/tree/main/docs/fulltext) for source versions, equations, configurations and each result’s scope. Historical records are described in [ARTIFACTS](https://github.com/tanjunkai2001/adp-matlab/blob/main/docs/ARTIFACTS.md).
